...
from projects.llava_sam2.models.preprocess.image_resize import  resize_pi3_patches_to_vit
...
class InternVL_Slowfast(InternVL_V1_5):
    ...
    def _llm_forward(
        ...
        if fast_pixel_values is not None:
            ...
            vit_embeds = vit_embeds + spatial_features
