...
video_scannetpp_dataset = dict(
    type=ScannetppDataset,
    image_folder="/globalwork/vipradas/scannet_images",
    expression_file="/home/vipradas/Thesis/Sa2VA_p/expressions/scanrefer_train_24.json",
