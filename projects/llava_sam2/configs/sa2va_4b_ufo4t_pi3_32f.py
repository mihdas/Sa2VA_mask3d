...
################## ViCaS dataset
vicas_expression_file = f"{language_data_path}/vicas_barecat/vicas.barecat"

vicas_multiturn_dataset= dict(
    type=VideoViCaSMultiTurnDataset,
    image_folder=vicas_expression_file,
...
################## SA1BDataset
sa1b_expression_file = f"{language_data_path}/sa1b_1M_barecat/sa1b_1M.barecat"
sa1b_dataset = dict(
    type=SA1BDataset,
    image_folder=sa1b_expression_file,
    tokenizer=tokenizer,
    template_map_fn=dict(type=template_map_fn_factory, template=prompt_template),
    max_length=max_length,
    lazy=True,
