...
def main():
    ...
    if rank != 0:
        print(f"Rank {rank} is not allowed to convert weights.")
        return
    print(f"Working on {rank}.")
    print(args)
    ...
    # copy the files
    code_folder = os.environ.get("CODE_FOLDER", "~/github/Sa2VA")
    os.system(f"cp -pr {code_folder}/projects/llava_sam2/hf/models/* {args.save_path}")
    # os.system(f"ln -s {code_folder}/projects/llava_sam2/hf/models/* {args.save_path}")
