...
EXPERIMENT_NAME=sa2va_4b_lila_8f_8t_fpn_zero3
EXPERIMENT_NOTES=""
...
export PROGRAM="tools/train.py projects/llava_sam2/configs/${EXPERIMENT_NAME}.py --launcher pytorch --deepspeed deepspeed_zero3"
