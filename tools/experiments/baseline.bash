...
sbatch --chdir="$LOG_FOLDER/code" --job-name="$EXPERIMENT_NAME" --output="$LOG_FOLDER/slurm-%j.out" "$HOME/github/vision-utils/scripts/juelich_run_v1.bash"
