...
export MODULE_CMD="module load Python Rust CUDA PyTorch Pillow-SIMD matplotlib scikit-learn scikit-image numba imageio git CMake torchvision ImageMagick SciPy-bundle GCC OpenMPI"
export VENV="source /p/project1/llmvidseg/alexey/code/Sa2VA/.venv2/bin/activate"
export TMPDIR=/p/scratch/llmvidseg/alexey/tmp
export TRITON_CACHE_DIR=/p/scratch/llmvidseg/alexey/tmp/triton

export PYTHONPATH="/p/project1/llmvidseg/alexey/code/Sa2VA/.venv2/lib/python3.12/site-packages:${PYTHONPATH}"
export PYTHONPATH="${LOG_FOLDER}/code${PYTHONPATH:+:$PYTHONPATH}"

# Execute sbatch command
sbatch --chdir="$LOG_FOLDER/code" --job-name="$EXPERIMENT_NAME" --output="$LOG_FOLDER/slurm-%j.out" "$HOME/github/vision-utils/scripts/juelich_run_v3.bash"
