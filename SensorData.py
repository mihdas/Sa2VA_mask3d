...
class RGBDFrame():
  ...
  def load(self, file_handle):
    ...
    self.color_data = struct.unpack(f'{self.color_size_bytes}s', file_handle.read(self.color_size_bytes))[0]
    self.depth_data = struct.unpack(f'{self.depth_size_bytes}s', file_handle.read(self.depth_size_bytes))[0]
...
class SensorData:
  ...
  def load(self, filename):
    with open(filename, 'rb') as f:
      ...
      self.sensor_name = struct.unpack(f'{strlen}s', f.read(strlen))[0].decode('utf-8')
